...
export default function Hero() {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-cyan-100 dark:from-gray-950 dark:to-cyan-950 transition-colors duration-200">
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center">
        ...
        <div className="hero-image md:w-1/2 mt-12 md:mt-0">
          <Image src="/hero.jpg" alt="Hero" width={600} height={400} className="" />
        </div>
      </div>
    </section>
  )
